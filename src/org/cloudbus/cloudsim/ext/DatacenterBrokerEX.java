...
public class DatacenterBrokerEX extends DatacenterBroker {
    ...
    protected void processCloudletReturn(SimEvent ev) {
        ...
        if (getLifeLength() <= 0) {
            ...
            CustomLog.printConcatLine(CloudSim.clock(), ": ", getName(), ": Cloudlet ", cloudlet.getCloudletId(), " received");
            cloudletsSubmitted--;
    ...
    private void processVMDestroy(SimEvent ev) {
        ...
        if (result == CloudSimTags.TRUE) {
            ...
            CustomLog.printConcatLine(CloudSim.clock(), ": ", getName(), ": VM #", vmId,
                    " has been destroyed in Datacenter #", datacenterId);
        } else {
            // Use the standard log for consistency ....
            CustomLog.printConcatLine(CloudSim.clock(), ": ", getName(), ": Desctuction of VM #", vmId,
