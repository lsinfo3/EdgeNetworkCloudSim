 ...
 */
public class DatacenterBrokerEdgeOld extends SimEntity {
	 ...
	 * @post $none
	 */
	public DatacenterBrokerEdgeOld(String name, final double lifeLength) throws Exception {
		super(name);
	...
	public DatacenterBrokerEdgeOld(String name) throws Exception {
		this(name, -1);
	}
	...
	protected void processVmCreate(SimEvent ev) {
		...
		if (result == CloudSimTags.TRUE) {
			...
			Log.printLine(CloudSim.clock() + ": " + getName() + ": VM #" + vmId + " created in Datacenter #"
