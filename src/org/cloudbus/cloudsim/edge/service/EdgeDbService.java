...
//				cl.getStages().add(new TaskStage(NetworkConstants.WAIT_RECV, 20000, 0, 0, cl.getMemory(), getBrokerVmId(),
						getBrokerCloudletId()));
...
//				cl.getStages().add(new TaskStage(NetworkConstants.WAIT_SEND, 20000, 0, 4, cl.getMemory(), getBrokerVmId(),
						getBrokerCloudletId()));
			}
			if (i == 1) {
				cl.setNumStage(5);
